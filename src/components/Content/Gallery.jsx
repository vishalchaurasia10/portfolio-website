...
const Gallery = () => {
    ...
    useEffect(() => {
        ...
        console.log(lastColumn.offsetHeight)
        console.log(lastColumnLastImage.offsetHeight)
        console.log(lastColumn.offsetHeight - lastColumnLastImage.offsetHeight - 10)
    ...
    return (
        <div className="container font-firaCode px-5 pb-32 md:w-full md:mx-auto">
            ...
            <div ref={ref} className="points w-[80%] mx-auto relative">
                ...
                <div className="contentGallery ml-2 md:ml-6 lg:ml-10 text-white">
                    <p className='text-[#57E6D9] text-sm mb-2'>August 12,2023</p>
                    <h3 className='mb-4'>Hackathon at BSIT,Bangalore</h3>
